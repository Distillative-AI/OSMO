...
![image](appendix/deploy_minimal.svg)
...
1. **Access OSMO Service API**:
   ...
   Visit [https:/](https:/)/<your-domain>/api/docs in your web browser to access the OSMO API.
2. **Access OSMO UI**:

   Visit [https:/](https:/)/<your-domain> in your web browser to access the OSMO UI.
