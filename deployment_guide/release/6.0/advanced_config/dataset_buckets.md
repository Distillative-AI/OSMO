...
Register external cloud storage buckets (S3, GCS, Azure) with OSMO to organize [datasets](https://nvidia.github.io/OSMO/user_guide/tutorials/data/index.html#datasets) across multiple storage locations (This configuration is optional)
...
#### SEE ALSO
- Learn more about datasets in OSMO at [Datasets](https://nvidia.github.io/OSMO/user_guide/tutorials/data/index.html#datasets)
