...
Suppose you have a training script [train.py](https://github.com/NVIDIA/OSMO/tree/main/workflows/dnn_training/single_node/train.py) ready to use.
...
![image](how_to/images/tensorboard.png)
