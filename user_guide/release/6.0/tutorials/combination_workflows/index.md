...
![Simple Combination Workflow](tutorials/combination_workflows/combination_workflow_simple.svg)
```yaml
...
![Complex Combination Workflow](tutorials/combination_workflows/combination_workflow_complex.svg)
```yaml
...
> ([osmo_barrier.py](https://github.com/NVIDIA/OSMO/tree/main/workflows/dnn_training/torchrun_multinode/osmo_barrier.py))
