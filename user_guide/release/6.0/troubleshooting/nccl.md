...
![Task Status and Exit Code Example](troubleshooting/nccl/workflow_overview.png)
...
| ![Task Logs Example](troubleshooting/nccl/task_logs_1.png)   | ![Logs Line Example](troubleshooting/nccl/task_logs_2.png)   |
|--------------------------------------------------------------|--------------------------------------------------------------|
...
![Resource Usage Dashboard Example](troubleshooting/nccl/resource_usage.png)
...
For more information, see [torch.distributed.init_process_group](https://pytorch.org/docs/stable/distributed.html#torch.distributed.init_process_group).
...
* [Debugging PyTorch Distributed Applications](https://pytorch.org/docs/stable/distributed.html#debugging-torch-distributed-applications)
